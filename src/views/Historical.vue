<template>
  <div class="fluid-container">
    ...
    <div class="container mt-4">
      <h1 class="text-center mb-4" style="color: #230007;">Historico de libros</h1>
      ...
      <div v-else>
        <p class="text-center">No hay libros para mostrar.</p>
      </div>
    </div>
    <!-- Cargamdo -->
