<template>
  <div>
    ...
    <div class="fluid-container">
      <h1 class="text-center p-3" style="color: #230007;">Perfil de Administrador</h1>
          ...
          <div class="col-12 col-md-8">
            <div class="row">
              ...
              <div class="col-12 col-md-6 mb-3">
                ...
                <input v-model="userFormData.Nombres" type="text" id="firstname"
              ...
              <div class="col-12 col-md-6 mb-3">
                ...
                <div v-if="!isEmailValid && userFormData.CorreoElectronico "
                  class="text-danger">
              ...
              <!-- LUGAR de residencia -->
              <div class="col-12 col-md-6 mb-3">
                <label for="birthplace" class="form-label txt-lg" style="color: #230007;">Pais de nacimiento</label>
              ...
              <div class="col-12 col-md-6 mb-3">
                <label for="birthplace" class="form-label txt-lg" style="color: #230007;">Estado de nacimiento</label>
              ...
              <div class="col-12 col-md-6 mb-3">
                <label for="birthplace" class="form-label txt-lg" style="color: #230007;">Ciudad de nacimiento</label>
            ...
            <button type="button" @click="registerUser" class="TardisBoton"
