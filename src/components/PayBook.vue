      ...
      <div class="row">
        <div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4">
              <p class="card-text product-price" style="text-align: left;">{{ Precio }} /Libro</p>
            </div>
            <div class="col-12 col-md-4">
              <p class="card-text product-total-price" style="text-align: left;">{{ TotalLibro }}</p>
            </div>
            </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      Genero: "",
      Admin: false,
      TotalLibro: new Intl.NumberFormat("es-CO", {
        style: "currency",
        currency: "COP",
      }).format(this.libro.Precio * this.libro.Cantidad),
    };
  },
  created() {
    this.Formatear();
